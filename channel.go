...
// 	result := fmt.Sprintf("Hai, May name is %s", student)
...
// 			result := fmt.Sprintf("Hy Myname is %s", student)
// 			c <- result
// 		}(v)
...
// 	fmt.Println("main go routine starts receifing data")
// 	d := <-c1
...
// 	time.Sleep(time.Second * 2)
// 	for v := range c1 {
// 		fmt.Println("main goroutine received value from chalnnel", v)
// 	}
